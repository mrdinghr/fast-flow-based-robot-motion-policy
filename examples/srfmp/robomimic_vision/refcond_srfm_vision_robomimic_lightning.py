...
from stable_model_trajs_robomimic_vision_pl_learntau import SRFMRobomimicVisionLTModule
import wandb
import sys
...
if __name__ == '__main__':
    ...
    print('load args')
    # Load config
    cfg = OmegaConf.load('refcond_srfm_robomimic_vision.yaml')
    cfg.model_type = 'Unet'
    # Load dataset
    ...
    # Construct model
    model = SRFMRobomimicVisionLTModule(cfg)
    # print(model)
