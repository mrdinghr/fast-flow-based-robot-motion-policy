...
# now only consider Bacth size = 1. used for real robot test
def projx_integrator_guided(
    manifold, odefunc, x0, t, method="euler", projx=True, local_coords=False, pbar=False, xref=None
):
    print('**************guided flow solving****************')
    step_fn = {
        "euler": euler_step,
        "midpoint": midpoint_step,
        "rk4": rk4_step,
